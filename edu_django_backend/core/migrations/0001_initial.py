# Generated by Django 5.0.4 on 2024-07-03 13:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(help_text='Enter phone number', max_length=20, unique=True, verbose_name='phone number')),
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('instructor', 'Instructor'), ('student', 'Student'), ('content_creator', 'Content Creator'), ('parent', 'Parent/Guardian')], default='student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('content_creator_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.contentcreator')),
